  ...
  it('获取由首字母分组的中文词语集合test', () => {
    const result = new Pinyin2Group().groupByFirstLetter([
      ...
      },
      {
        options: {
          brandCode: 'BMW',
          imageUrl: 'https://parts-images.oss-cn-shenzhen.aliyuncs.com/brand_logo/BMW.png',
        },
        word: '吧欧',
      },
      {
      ...
      },
      {
        options: {
          brandCode: 'INFINITI',
          imageUrl: 'https://parts-images.oss-cn-shenzhen.aliyuncs.com/brand_logo/INFINITI.png',
        },
        word: '英菲尼迪',
      },
      {
      ...
      }] },
    {
      ...
      wordsList: [{
        options:
        {
          brandCode: 'BMW',
          imageUrl:
            'https://parts-images.oss-cn-shenzhen.aliyuncs.com/brand_logo/BMW.png',
        },
        word: '吧奥',
    ...
    { letter: 'Y',
      wordsList: [{
        options:
        {
          brandCode: 'INFINITI',
          imageUrl:
            'https://parts-images.oss-cn-shenzhen.aliyuncs.com/brand_logo/INFINITI.png',
        },
        word: '英菲尼迪',
